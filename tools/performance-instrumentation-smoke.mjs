import { resourceCategory, summarizeFrameTimes, summarizeResources } from '../src/performance-instrumentation.js'
...
check(resources.categories.image.transferBytes === 200, 'resource summaries aggregate transfer bytes by category')
