...
status: UNREAL ENGINE · PARTY GAME · GAME DESIGN
stack: [Unreal Engine, C++, Blueprints, Game Design, Multiplayer, Audio]
theme: synthwave
...
## ENGINEERING: GAME FLOW AS STATES
...
The engineering side follows the same principle. Explicit game-flow states reduce phase-management ambiguity, while data-driven audio reduces repeated integration work. Both systems make iteration cheaper — which matters because a party game's quality is discovered by repeatedly putting rules in front of several players and watching where the intended social behavior actually appears.

::note
ASTRO'S CORE LESSON — A PARTY GAME DOES NOT NEED THE MOST MECHANICS. IT NEEDS A SMALL SET OF RULES THAT KEEP CHANGING WHAT PLAYERS WANT FROM EACH OTHER.
::
