...
DIRECTOR AI | MACRO LAYER THAT MONITORS THE PLAYER
PRESSURE SIGNAL | GUIDES WHERE THREAT SHOULD EMERGE
CREATURE AI | MICRO LAYER DRIVEN BY SENSORS + BEHAVIOURS
LOCAL SEARCH | TRACK, INVESTIGATE AND REACT
PLAYER RESPONSE | HIDE, DIVERT, ESCAPE AND REPOSITION
::

::note
THE GOAL IS NOT PERFECT INFORMATION FOR THE CREATURE. THE DIRECTOR CAN MANAGE PRESSURE WHILE THE CREATURE STILL HAS TO SEARCH LOCALLY.
::
